exports.signup = function(req, res){
  ...
  if(req.method == "POST"){
     ...
     var passyear= post.passyear;
     var mobile= post.mobile;
     
   if(username !='' && password!='') {
     var sql = "INSERT INTO `users`(`first_name`,`last_name`,`mobile`,`course`,`passyear`,`username`, `password`) VALUES ('" + fname + "','" + lname + "','" + mobile + "','" + username + "','" + password + "')";
